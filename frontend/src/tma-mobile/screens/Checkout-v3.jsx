      ...
      <div className="checkout" data-testid="checkout-v3">
        ...
        <div className="checkout__wrapper">
          <div className="checkout__progress">
            <div
              className={`checkout__dot ${step >= 1 ? "checkout__dot--active" : ""}`}
            />
            <div
              className={`checkout__dot ${step >= 2 ? "checkout__dot--active" : ""}`}
            />
            <div
              className={`checkout__dot ${step >= 3 ? "checkout__dot--active" : ""}`}
            />
            <div
              className={`checkout__dot ${step >= 4 ? "checkout__dot--active" : ""}`}
            />
          </div>
            ...
            {step === 1 && (
              <div className="checkout__step" data-testid="checkout-step-1">
                ...
                <p className="checkout__subtitle">
                  Куди відправити ваше замовлення?
                </p>
              ...
              <div className="checkout__step" data-testid="checkout-step-3">
                ...
                >
                  ...
                  <div className="checkout__option-body">
                    ...
                    <div className="checkout__option-sub">
                      WayForPay · безпечна оплата
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="checkout__option-body">
                    <div className="checkout__option-title">
                      Накладений платіж
                    </div>
                    <div className="checkout__option-sub">
                ...
                {shippingCost > 0 && (
                  <div className="checkout__shipping-info">
                    <div className="checkout__shipping-hint">
                      ℹ️ <strong>Вартість доставки</strong> включена в суму
                      замовлення (Нова Пошта).
                      <div
                        style={{
                          fontSize: "12px",
                          marginTop: "4px",
